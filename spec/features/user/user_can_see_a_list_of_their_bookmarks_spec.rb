    ...
    it 'I see a list of all my bookmarks' do
      VCR.use_cassette('/user/user_can_see_bookmarks') do
        ...
        within('section#bookmarks') do
          ...
          expect(page).to_not have_content(tutorial1_videos[1].title.to_s)
          expect(page).to_not have_content(tutorial1_videos[2].title.to_s)
          expect(page).to_not have_content(tutorial2_video1.title.to_s)
        end
        ...
        within('section#bookmarks') do
          ...
          expect(page).to_not have_content(tutorial1_videos[0].title.to_s)
          expect(page).to_not have_content(tutorial2_video3.title.to_s)
          expect(page).to_not have_content(tutorial2_video2.title.to_s)
          expect(page).to_not have_content(video3[2].title.to_s)
        end
      end
    end
  end

...
const context = __webpack_require__("./app/javascript/packs/controllers sync recursive \\.js$");
...
var map = {
	"./tutorials_controller.js": "./app/javascript/packs/controllers/tutorials_controller.js"
};
...
/* harmony default export */ __webpack_exports__["default"] = (class extends stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"] {
  showDescription(event) {
    ...
    fetch(`/api/v1/videos/${event.target.id}`).then(response => response.json()).then(function (response) {
...
/******/ });
//# sourceMappingURL=application-551a83dd0ec6d6c8f18a.js.map